...
console.log(string[0]+string[1]);
  if(string[1] === '1'){
var choice = 'SELECT * FROM ustanove,podaci,kzn WHERE SLOBODNI_TERMIN > NOW() AND ustanove.USTANOVA_ID=podaci.USTANOVA_ID AND kzn.ZAHVAT_ID=podaci.ZAHVAT_ID and kzn.IME="'+string[0]+'" ORDER BY SLOBODNI_TERMIN ASC limit 10';
}else if(string[1]==='2'){
